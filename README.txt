...
El plugin RVCFDI para WooCommerce integra RV Factura Electronica Web, permitiendo facturaci—n electr—nica de ventas realizadas en tu sitio WooCommerce.

== Description ==
El plugin RVCFDI para WooCommerce es una herramienta que se integrabcon RV Factura Electronica Web y te permite llevar a cabo el proceso facturacion electronica de tus ventas realizadas a tus clientes con WooCommerce en tu sitio web, almacenando tus CFDI en RV Factura Electronica Web con la posibilidad de administrarlos tambien en tu panel de administracion del plugin en Wordpress.
...
== Changelog ==
8.1.2 Mejoras internas en la emision de CFDI.
8.1.1 Mejoras internas en la emision de CFDI.
